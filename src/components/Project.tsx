    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full mt-2 sm:mt-4 gap-4 sm:gap-0">
        <h3 className="text-3xl sm:text-4xl md:text-5xl font-semibold">
          {projectData.headings.headingNormal}{" "}
          <span className="text-primary">
            {projectData.headings.headingHighlighted}
          </span>
        </h3>
        <Link
          href="/projects"
          className="flex items-center justify-center gap-2 bg-primary text-foreground px-6 sm:px-8 py-3 sm:py-4 rounded-full shadow-lg hover:bg-primary/90 transition-all duration-300 font-semibold group cursor-pointer whitespace-nowrap"
        >
          {projectData.button}
            ...
            >
              ...
              <div className="mt-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="border border-primary p-2 rounded-full flex-shrink-0 group-hover:bg-primary group-hover:text-white transition-all duration-300 cursor-pointer">
                    <ArrowUpRight />
                  </div>
                </div>
              </div>
